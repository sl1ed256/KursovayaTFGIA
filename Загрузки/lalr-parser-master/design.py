# Конструирование формы через библиотеку PyQt4
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lr = QtGui.QPushButton(self.groupBox_2)
        self.lr.setGeometry(QtCore.QRect(340, 10, 111, 31))
        ...
        MainWindow.setTabOrder(self.first, self.lr)
        MainWindow.setTabOrder(self.lr, self.lalr)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "Введите выражение :", None))
        self.parse.setText(_translate("MainWindow", "Обработать", None))
        self.display.setText(_translate("MainWindow", "Обр. грам.", None))
        self.first.setText(_translate("MainWindow", "First", None))
        self.lr.setText(_translate("MainWindow", "LR ситуации", None))
        self.lalr.setText(_translate("MainWindow", "LALR ситуации", None))
        self.parse_table.setText(_translate("MainWindow", "Управл. табл.", None))
        self.label_2.setText(_translate("MainWindow", "Ввод грамматики:", None))
        self.label.setText(_translate("MainWindow", "LALR анализ", None))
        self.label_4.setText(_translate("MainWindow", "\'e\' : эпсилон", None))
        self.menu_File.setTitle(_translate("MainWindow", "&Файл", None))
        self.menu_About.setTitle(_translate("MainWindow", "&Об авторах", None))
        self.action_Open.setText(_translate("MainWindow", "&Открыть", None))
        ...
        self.actionAuthor.setText(_translate("MainWindow", "Авторы", None))
